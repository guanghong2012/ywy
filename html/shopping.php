...
<body>
	...
	<div class="shopping_div">
		<div class="w1200">
			<div class="shop_div1" style="background:url(images/b4.png) no-repeat right center">
				<h2>购物车列表</h2>
				<a href="">展开全部详细信息</a>
				<div class="clear"></div>
			</div>
			...
			<div class="shop_div3">
				<div class="tdw70 div_ty">
					<input id="checkbox-1-2" class="regular-checkbox" checked="" type="checkbox"><label class="label_1" for="checkbox-1-2"></label> 
				</div>
				...
				<div class="tdw380 div_ty">
					<h3>基本价格：240.00 + 增值价格：0.00 = 240.00 元</h3>
				</div>
				<div class="tdw160 div_ty">
					<a class="a1" onclick='show("tip1")'>详情</a>
					<a class="a2" href="">删除</a>
				</div>	
				<div class="clear"></div>
				<div id="tip1" class="tip_div" style="	display:none;">
					<div class="div1">
						<div class="div1_1">
							<h2>方案信息</h2>
							<ul>
								<li><span>方案名称：</span>飓风2s型（单线）</li>
								<li><span>操作系统：</span>CENTOS6</li>
							</ul>
							<div class="clear"></div>
						</div>
						<div class="div1_2">
							...
							<ul>
								<li>
									<p><span>线路：</span>电信单线</p>
									<p><span>同时最大连接数：</span>150个</p>
									<p><span>MySQL空间限制：</span>30MB</p>
								</li>
								<li>
									<p><span>WWW站点：</span>支持</p>
									<p><span>磁盘空间限制：</span>200M</p>
								</li>
								<li>
									<p><span>WWW站点：</span>支持</p>
									<p><span>磁盘空间限制：</span>200M</p>
								...
								<li>
									<p><span>带宽限制：</span>250KB/秒</p>
									<p><span>PHP版本：</span>5.2</p>
								</li>
								<li>
									<p><span>流量限制：</span>20000MB/月</p>
			...
			<div class="shop_div3">
				<div class="tdw70 div_ty">
					<input id="checkbox-1-3" class="regular-checkbox" checked="" type="checkbox"><label class="label_1" for="checkbox-1-3"></label> 
				</div>
				<div class="tdw235 div_ty">
					<h2>.com英文国际域名</h2>
				</div>
				...
				<div class="tdw380 div_ty">
					<h3>基本价格：88.00 + 增值价格：0.00 = 88.00 元</h3>
				</div>
				<div class="tdw160 div_ty">
					<a class="a1" onclick='show("tip2")'>详情</a>
					<a class="a2" href="">删除</a>
				</div>	
				<div class="clear"></div>
				<div id="tip2" class="tip_div" style="	display:none;" >
					<div class="div1">
						<div class="div1_1">
							<h2>方案信息</h2>
							<ul>
			...
			<div class="shop_div4">
				<h2>
					...
					<a class="a2" href="shopping_1.php">下一步</a>
					<span>总价：<em>240.00 元</em></span>
					<span>您已选择：<em>1</em>件商品</span>
				</h2>
			</div>
		</div>
	</div>
