...
class CuserApi extends Api{
    /**
     * 构造方法，实例化操作模型
     */
    protected function _init(){
        $this->model = new CuserModel();
    }
     ...
     */
    public function register($username, $password, $email, $mobile = '',$address=''){
        return $this->model->register($username, $password, $email, $mobile,$address);
    }
